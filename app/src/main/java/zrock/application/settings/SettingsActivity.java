package zrock.application.settings;
...
public class SettingsActivity extends PreferenceActivity {
    ...
    public void setContentView(int layoutResID) {
        ViewGroup contentView = (ViewGroup) LayoutInflater.from(this).inflate(R.layout.activity_application_settings, new LinearLayout(this), false);
